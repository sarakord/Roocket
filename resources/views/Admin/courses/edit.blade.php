        ...
        <form class="form-horizontal" action="{{ route('courses.update' , $course->id) }}" method="post"
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <select name="type" id="type" class="form-control">
                        ...
                        <option value="cashe" {{ $course->type == 'cashe'? 'selected' :''  }}>نقدی</option>
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <textarea rows="8" class="form-control" name="description"
                              id="body">{{ $course->description }}</textarea>
                </div>
            </div>
            {{--<div class="form-group">
                <div class="col-sm-12">
                    <label for="body" class="control-label">متن</label>
                    <textarea rows="5" class="form-control" name="body" id="body">{{ $course->body }}</textarea>
                </div>
            </div>--}}
            <div class="form-group">
                <div class="col-sm-12">
            ...
            <div class="form-group">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" name="price" id="tags" placeholder="قیمت را وارد کنید"
                           value="{{ $course->price }}">
                </div>
                <div class="col-sm-6">
                    <label for="tags" class="control-label">تگ ها</label>
                    <input type="text" class="form-control" name="tags" id="tags" value="{{ $course->tags }}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-12">
                    <button type="submit" class="btn btn-success">ارسال</button>
                    <a href="{{route('courses.index')}}" class="btn btn-warning">انصراف </a>
                </div>
            </div>
        </form>
    </div>
