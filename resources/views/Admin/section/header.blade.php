    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li><a href="{{route('payments.index')}}">پرداختی های موفق <span class="badge">{{$paymentSuccessfulCount}}</span></a></li>
                <li><a href="{{route('payments.unsuccessful')}}">پرداختی های ناموفق <span class="badge">{{$paymentUnsuccessfulCount}}</span></a></li>
            </ul>
            <ul class="nav nav-sidebar">
